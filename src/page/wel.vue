    ...
    <div class="wel__header">
      ...
      <div class="wel__extra">
        ...
        <div class="wel__extra-item">
          ...
          <p class="wel__extra-subtitle">
            {{contionCount}} <span>/ {{contionInfoCount}}</span>
          </p>
        </div>
        <div class="wel__extra-item">
          <p class="wel__extra-title">
...
<script>
  ...
  import {getWebSite} from '@/api/index'
  export default {
    name: "wel",
    data() {
      return {
    ...
    computed: {
      ...
      option4() {
        return {
          ...
          column: [
            {
              label: this.$t("wel.table.title"),
              prop: "title"
            },
            {
              width: 500,
              label: this.$t("wel.table.content"),
              prop: "content",
              overHidden: true
            },
            {
              label: this.$t("wel.table.createDate"),
              type:'date',
      ...
      handleList() {
        ...
        getWebSite().then(res => {
          ...
          var a = {
            ...
            data: [
              {
                title: that.$t("wel.data4.column1"),
                count: data.sumCount,
              ...
              {
                title: that.$t("wel.data4.column2"),
                count: data.dayCount,
                icon: "el-icon-view",
                color: "rgb(56, 161, 242)",
              ...
              {
                title: that.$t("wel.data4.column3"),
                count: data.sumPayCount,
                icon: "el-icon-setting",
                color: "rgb(117, 56, 199)",
              },
              {
                title: that.$t("wel.data4.column4"),
                count: data.dayPayCount,
                icon: "el-icon-setting",
                color: "rgb(230, 71, 88)",
          ...
          that.contionCount=data.contionCount;
          that.contionInfoCount=data.contionInfoCount;
          that.tutorCount=data.tutorCount;
          that.data=data.adminNotices;
