...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/AdminNotice/AdminNotice';
    import { mapGetters } from "vuex";
    import { adminNoticeOption } from "@/const/mantuoluo/AdminNotice/AdminNoticeTableOption.js";
    export default {
        name: "AdminNotice",
        components: {},
        data () {
            return {
                tableOption: adminNoticeOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
