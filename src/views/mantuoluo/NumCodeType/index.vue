...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/NumCodeType/NumCodeType';
    import { mapGetters } from "vuex";
    import { numCodeTypeOption } from "@/const/mantuoluo/NumCodeType/NumCodeTypeTableOption.js";
    export default {
        name: "NumCodeType",
        components: {},
        data () {
            return {
                tableOption: numCodeTypeOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
