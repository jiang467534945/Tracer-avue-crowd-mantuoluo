...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/DDetails/DDetails';
    import { mapGetters } from "vuex";
    import { dDetailsOption } from "@/const/mantuoluo/DDetails/DDetailsTableOption.js";
    export default {
        name: "DDetails",
        components: {},
        data () {
            return {
                tableOption: dDetailsOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
