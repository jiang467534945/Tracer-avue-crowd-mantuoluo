...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/OrderTutor/OrderTutor';
    import { mapGetters } from "vuex";
    import { orderTutorOption } from "@/const/mantuoluo/OrderTutor/OrderTutorTableOption.js";
    export default {
        name: "OrderTutor",
        components: {},
        data () {
            return {
                tableOption: orderTutorOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
