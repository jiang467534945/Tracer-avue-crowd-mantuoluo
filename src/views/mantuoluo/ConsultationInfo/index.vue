...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/ConsultationInfo/ConsultationInfo';
    import { mapGetters } from "vuex";
    import { consultationInfoOption } from "@/const/mantuoluo/ConsultationInfo/ConsultationInfoTableOption.js";
    export default {
        name: "ConsultationInfo",
        components: {},
        data () {
            return {
                tableOption: consultationInfoOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
