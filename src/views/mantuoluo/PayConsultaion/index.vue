...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/PayConsultaion/PayConsultaion';
    import { mapGetters } from "vuex";
    import { payConsultaionOption } from "@/const/mantuoluo/PayConsultaion/PayConsultaionTableOption.js";
    export default {
        name: "PayConsultaion",
        components: {},
        data () {
            return {
                tableOption: payConsultaionOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
