...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/NumType/NumType';
    import { mapGetters } from "vuex";
    import { numTypeOption } from "@/const/mantuoluo/NumType/NumTypeTableOption.js";
    export default {
        name: "NumType",
        components: {},
        data () {
            return {
                tableOption: numTypeOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
