...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/NumCode/NumCode';
    import { mapGetters } from "vuex";
    import { numCodeOption } from "@/const/mantuoluo/NumCode/NumCodeTableOption.js";
    export default {
        name: "NumCode",
        components: {},
        data () {
            return {
                tableOption: numCodeOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
