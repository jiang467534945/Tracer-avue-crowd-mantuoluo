...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/SiteSetting/SiteSetting';
    import { mapGetters } from "vuex";
    import { siteSettingOption } from "@/const/mantuoluo/SiteSetting/SiteSettingTableOption.js";
    export default {
        name: "SiteSetting",
        components: {},
        data () {
            return {
                tableOption: siteSettingOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
