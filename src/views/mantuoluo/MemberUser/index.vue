...
<script>
    import {getPageList,add,edit,del} from '@/api/mantuoluo/MemberUser/MemberUser';
    import { mapGetters } from "vuex";
    import { memberUserOption } from "@/const/mantuoluo/MemberUser/MemberUserTableOption.js";
    export default {
        name: "MemberUser",
        components: {},
        data () {
            return {
                tableOption: memberUserOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
